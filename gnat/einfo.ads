...
--       or in out parameter. Note that this flag is not set from using an
...
--       to the entity that is being wrapped.
   ...
   --    Protected_Formal                    (Node22)
   --    Extra_Constrained                   (Node23)
   --    Has_Initial_Value                   (Flag219)  (out parameters only)
   --    Is_Controlling_Formal               (Flag97)
   --    Is_Entry_Formal                     (Flag52)
   --    Is_Optional_Parameter               (Flag134)
   --    Low_Bound_Known                     (Flag205)
   ...
   --    Has_Dispatch_Table                  (Flag220)  (base type only)
   --    Has_External_Tag_Rep_Clause         (Flag110)
