...
procedure Gprname is
   ...
   package body Maker is separate;
...
begin
   ...
   for J in 1 .. Arguments.Last loop
      ...
      begin
         ...
         --  Call Maker.Process where the real work is done
