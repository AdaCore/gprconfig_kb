...
--              end case;
      ...
      begin
         ...
         if Data.Include_Language /= Id.Language then
            ...
            elsif Id.Language.Config.Include_Switches_Via_Spec /= No_Name_List
            then
               declare
...
--                  Data.Imported_Dirs_Switches := new String_List (1 .. 2);
--                  Data.Imported_Dirs_Switches (1) := new String'("-specs");
--                  Data.Imported_Dirs_Switches (2) :=
