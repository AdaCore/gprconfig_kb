...
package GPR.Snames is
   ...
   Name_Side_Debug                       : constant Name_Id := N + 243;
   ...
   Name_Runtime_Library_Dirs             : constant Name_Id := N + 263;
   Name_Runtime_Source_Dir               : constant Name_Id := N + 264;
   Name_Ada                              : constant Name_Id := N + 265;
   Name_Interfaces                       : constant Name_Id := N + 266;
   Name_Main                             : constant Name_Id := N + 267;
   Name_Target                           : constant Name_Id := N + 268;
   Name_Casing                           : constant Name_Id := N + 269;
   Name_Dot_Replacement                  : constant Name_Id := N + 270;
   Name_Standard                         : constant Name_Id := N + 271;
   Name_Name                             : constant Name_Id := N + 272;
   Name_Linker_Options                   : constant Name_Id := N + 273;
   Name_Runtime                          : constant Name_Id := N + 274;
   Name_Mode                             : constant Name_Id := N + 275;
   Name_Install_Name                     : constant Name_Id := N + 276;
   Name_Object_Lister                    : constant Name_Id := N + 277;
   Name_Object_Lister_Matcher            : constant Name_Id := N + 278;
   Name_Export_File_Format               : constant Name_Id := N + 279;
   Name_Export_File_Switch               : constant Name_Id := N + 280;
   Name_Runtime_Source_Dirs              : constant Name_Id := N + 281;
   Name_Runtime_Dir                      : constant Name_Id := N + 282;
   Name_Runtime_Library_Version          : constant Name_Id := N + 283;
   Name_Split                            : constant Name_Id := N + 284;
   Name_Create_Missing_Dirs              : constant Name_Id := N + 285;
