...
package GPR.Snames is
   ...
   Name_ALI_Subdir                       : constant Name_Id := N + 168;
   Name_Lib_Subdir                       : constant Name_Id := N + 169;
   Name_Link_Lib_Subdir                  : constant Name_Id := N + 170;
   Name_Library                          : constant Name_Id := N + 171;
   Name_Library_Ali_Dir                  : constant Name_Id := N + 172;
   Name_Library_Auto_Init                : constant Name_Id := N + 173;
   Name_Library_Auto_Init_Supported      : constant Name_Id := N + 174;
   Name_Library_Builder                  : constant Name_Id := N + 175;
   Name_Library_Dir                      : constant Name_Id := N + 176;
   Name_Library_GCC                      : constant Name_Id := N + 177;
   Name_Library_Install_Name_Option      : constant Name_Id := N + 178;
   Name_Library_Interface                : constant Name_Id := N + 179;
   Name_Library_Kind                     : constant Name_Id := N + 180;
   Name_Library_Name                     : constant Name_Id := N + 181;
   Name_Library_Major_Minor_Id_Supported : constant Name_Id := N + 182;
   Name_Library_Options                  : constant Name_Id := N + 183;
   Name_Library_Partial_Linker           : constant Name_Id := N + 184;
   ...
   Name_Required_Artifacts               : constant Name_Id := N + 236;
   Name_Required_Switches                : constant Name_Id := N + 237;
   Name_Run_Path_Option                  : constant Name_Id := N + 238;
   Name_Run_Path_Origin                  : constant Name_Id := N + 239;
   Name_Separate_Run_Path_Options        : constant Name_Id := N + 240;
   Name_Shared_Library_Minimum_Switches  : constant Name_Id := N + 241;
   Name_Shared_Library_Prefix            : constant Name_Id := N + 242;
   Name_Shared_Library_Suffix            : constant Name_Id := N + 243;
   Name_Separate_Suffix                  : constant Name_Id := N + 244;
   Name_Side_Debug                       : constant Name_Id := N + 245;
   Name_Source_Artifact_Extensions       : constant Name_Id := N + 246;
   Name_Source_Dirs                      : constant Name_Id := N + 247;
   Name_Source_File_Switches             : constant Name_Id := N + 248;
   Name_Source_Files                     : constant Name_Id := N + 249;
   Name_Source_List_File                 : constant Name_Id := N + 250;
   Name_Sources_Subdir                   : constant Name_Id := N + 251;
   Name_Spec                             : constant Name_Id := N + 252;
   Name_Spec_Suffix                      : constant Name_Id := N + 253;
   Name_Specification                    : constant Name_Id := N + 254;
   Name_Specification_Exceptions         : constant Name_Id := N + 255;
   Name_Specification_Suffix             : constant Name_Id := N + 256;
   Name_Stack                            : constant Name_Id := N + 257;
   Name_Switches                         : constant Name_Id := N + 258;
   Name_Symbolic_Link_Supported          : constant Name_Id := N + 259;
   Name_Toolchain_Description            : constant Name_Id := N + 260;
   Name_Toolchain_Version                : constant Name_Id := N + 261;
   Name_Trailing_Required_Switches       : constant Name_Id := N + 262;
   Name_Trailing_Switches                : constant Name_Id := N + 263;
   Name_Runtime_Library_Dir              : constant Name_Id := N + 264;
   Name_Runtime_Library_Dirs             : constant Name_Id := N + 265;
   Name_Runtime_Source_Dir               : constant Name_Id := N + 266;
   Name_Ada                              : constant Name_Id := N + 267;
   Name_Interfaces                       : constant Name_Id := N + 268;
   Name_Main                             : constant Name_Id := N + 269;
   Name_Target                           : constant Name_Id := N + 270;
   Name_Casing                           : constant Name_Id := N + 271;
   Name_Dot_Replacement                  : constant Name_Id := N + 272;
   Name_Standard                         : constant Name_Id := N + 273;
   Name_Name                             : constant Name_Id := N + 274;
   Name_Linker_Options                   : constant Name_Id := N + 275;
   Name_Runtime                          : constant Name_Id := N + 276;
   Name_Mode                             : constant Name_Id := N + 277;
   Name_Install_Name                     : constant Name_Id := N + 278;
   Name_Object_Lister                    : constant Name_Id := N + 279;
   Name_Object_Lister_Matcher            : constant Name_Id := N + 280;
   Name_Export_File_Format               : constant Name_Id := N + 281;
   Name_Export_File_Switch               : constant Name_Id := N + 282;
   Name_Runtime_Source_Dirs              : constant Name_Id := N + 283;
   Name_Runtime_Dir                      : constant Name_Id := N + 284;
   Name_Runtime_Library_Version          : constant Name_Id := N + 285;
   Name_Split                            : constant Name_Id := N + 286;
   Name_Create_Missing_Dirs              : constant Name_Id := N + 287;
