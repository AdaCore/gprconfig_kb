...
package GPR.Snames is
   ...
   Name_Library_Rpath_Options            : constant Name_Id := N + 184;
   Name_Library_Standalone               : constant Name_Id := N + 185;
   Name_Library_Encapsulated_Options     : constant Name_Id := N + 186;
   Name_Library_Encapsulated_Supported   : constant Name_Id := N + 187;
   Name_Library_Src_Dir                  : constant Name_Id := N + 188;
   Name_Library_Support                  : constant Name_Id := N + 189;
   Name_Library_Symbol_File              : constant Name_Id := N + 190;
   Name_Library_Symbol_Policy            : constant Name_Id := N + 191;
   Name_Library_Version                  : constant Name_Id := N + 192;
   Name_Library_Version_Switches         : constant Name_Id := N + 193;
   Name_Linker                           : constant Name_Id := N + 194;
   Name_Linker_Executable_Option         : constant Name_Id := N + 195;
   Name_Linker_Lib_Dir_Option            : constant Name_Id := N + 196;
   Name_Linker_Lib_Name_Option           : constant Name_Id := N + 197;
   Name_Local_Config_File                : constant Name_Id := N + 198;
   Name_Local_Configuration_Pragmas      : constant Name_Id := N + 199;
   Name_Locally_Removed_Files            : constant Name_Id := N + 200;
   Name_Map_File_Option                  : constant Name_Id := N + 201;
   Name_Mapping_File_Switches            : constant Name_Id := N + 202;
   Name_Mapping_Spec_Suffix              : constant Name_Id := N + 203;
   Name_Mapping_Body_Suffix              : constant Name_Id := N + 204;
   Name_Max_Command_Line_Length          : constant Name_Id := N + 205;
   Name_Metrics                          : constant Name_Id := N + 206;
   Name_Multi_Unit_Object_Separator      : constant Name_Id := N + 207;
   Name_Multi_Unit_Switches              : constant Name_Id := N + 208;
   Name_Naming                           : constant Name_Id := N + 209;
   Name_None                             : constant Name_Id := N + 210;
   Name_Object_Artifact_Extensions       : constant Name_Id := N + 211;
   Name_Object_File_Suffix               : constant Name_Id := N + 212;
   Name_Object_File_Switches             : constant Name_Id := N + 213;
   Name_Object_Generated                 : constant Name_Id := N + 214;
   Name_Object_List                      : constant Name_Id := N + 215;
   Name_Object_Path_Switches             : constant Name_Id := N + 216;
   Name_Objects_Linked                   : constant Name_Id := N + 217;
   Name_Objects_Path                     : constant Name_Id := N + 218;
   Name_Objects_Path_File                : constant Name_Id := N + 219;
   Name_Object_Dir                       : constant Name_Id := N + 220;
   Name_Option_List                      : constant Name_Id := N + 221;
   Name_Path_Syntax                      : constant Name_Id := N + 222;
   Name_Pic_Option                       : constant Name_Id := N + 223;
   Name_Pretty_Printer                   : constant Name_Id := N + 224;
   Name_Prefix                           : constant Name_Id := N + 225;
   Name_Project_Dir                      : constant Name_Id := N + 226;
   Name_Project_Files                    : constant Name_Id := N + 227;
   Name_Project_Path                     : constant Name_Id := N + 228;
   Name_Project_Subdir                   : constant Name_Id := N + 229;
   Name_Remote                           : constant Name_Id := N + 230;
   Name_Response_File_Format             : constant Name_Id := N + 231;
   Name_Response_File_Switches           : constant Name_Id := N + 232;
   Name_Root_Dir                         : constant Name_Id := N + 233;
   Name_Roots                            : constant Name_Id := N + 234;
   Name_Required_Switches                : constant Name_Id := N + 235;
   Name_Run_Path_Option                  : constant Name_Id := N + 236;
   Name_Run_Path_Origin                  : constant Name_Id := N + 237;
   Name_Separate_Run_Path_Options        : constant Name_Id := N + 238;
   Name_Shared_Library_Minimum_Switches  : constant Name_Id := N + 239;
   Name_Shared_Library_Prefix            : constant Name_Id := N + 240;
   Name_Shared_Library_Suffix            : constant Name_Id := N + 241;
   Name_Separate_Suffix                  : constant Name_Id := N + 242;
   Name_Source_Artifact_Extensions       : constant Name_Id := N + 243;
   Name_Source_Dirs                      : constant Name_Id := N + 244;
   Name_Source_File_Switches             : constant Name_Id := N + 245;
   Name_Source_Files                     : constant Name_Id := N + 246;
   Name_Source_List_File                 : constant Name_Id := N + 247;
   Name_Sources_Subdir                   : constant Name_Id := N + 248;
   Name_Spec                             : constant Name_Id := N + 249;
   Name_Spec_Suffix                      : constant Name_Id := N + 250;
   Name_Specification                    : constant Name_Id := N + 251;
   Name_Specification_Exceptions         : constant Name_Id := N + 252;
   Name_Specification_Suffix             : constant Name_Id := N + 253;
   Name_Stack                            : constant Name_Id := N + 254;
   Name_Switches                         : constant Name_Id := N + 255;
   Name_Symbolic_Link_Supported          : constant Name_Id := N + 256;
   Name_Toolchain_Description            : constant Name_Id := N + 257;
   Name_Toolchain_Version                : constant Name_Id := N + 258;
   Name_Trailing_Required_Switches       : constant Name_Id := N + 259;
   Name_Trailing_Switches                : constant Name_Id := N + 260;
   Name_Runtime_Library_Dir              : constant Name_Id := N + 261;
   Name_Runtime_Source_Dir               : constant Name_Id := N + 262;
   Name_Ada                              : constant Name_Id := N + 263;
   Name_Interfaces                       : constant Name_Id := N + 264;
   Name_Main                             : constant Name_Id := N + 265;
   Name_Target                           : constant Name_Id := N + 266;
   Name_Casing                           : constant Name_Id := N + 267;
   Name_Dot_Replacement                  : constant Name_Id := N + 268;
   Name_Standard                         : constant Name_Id := N + 269;
   Name_Name                             : constant Name_Id := N + 270;
   Name_Linker_Options                   : constant Name_Id := N + 271;
   Name_Runtime                          : constant Name_Id := N + 272;
   Name_Mode                             : constant Name_Id := N + 273;
   Name_Install_Name                     : constant Name_Id := N + 274;
   Name_Object_Lister                    : constant Name_Id := N + 275;
   Name_Object_Lister_Matcher            : constant Name_Id := N + 276;
   Name_Export_File_Format               : constant Name_Id := N + 277;
